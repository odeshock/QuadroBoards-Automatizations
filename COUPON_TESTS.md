...
Корректировки: +20₽ (эффективно 7-2=5 подарков ≥ 5: 40×1×5 - 180×1 = 20)
Автоскидки: +175₽ (75% от (724-471-20) = 75% от 233 = 175, округление вверх)
ИТОГО: -58₽
```


❌  **Система считает неверно!**
```
Подарки: -280₽
Инд. иконки: -444₽

А вот тут!!
Купоны: итого почему-то выводит +495
  Хотя в итогах логика правильно расписана
  Подарки:
    - Скидка на 2 подарка: 80
    - Скидка -180₽: 180
  Иконки:
