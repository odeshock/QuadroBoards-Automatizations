...
export const TEXT_MESSAGES = {
  ...
  ADMIN_INFO: 'Начисление производит администратор при приёме анкеты. Если Вас случайно пропустили, пожалуйста, напишите в Приёмную — мы обязательно разберемся.',
  SCRIPT_INFO: 'За Вас все посчитает скрипт, просто дайте ему время. Если у Вас возникнут вопросы по подсчету или что-то окажется не учтено, пожалуйста, напишите в Приёмную — мы обязательно поможем.',
  TOPUP_INFO: 'Начисление производит администратор 1го и 16го числа каждого месяца. Если Вам случайно забыли начислить, пожалуйста, напишите в Приёмную — мы обязательно разберемся.',
