...
export const incomeItems = [
  ...
  { title: 'Докупить кредиты', amount: 'ч', mode: CALC_MODES.PRICE_PER_ITEM, form: FORM_INCOME_TOPUP },
  { title: 'Выдать денежку дополнительно', amount: 'ч', mode: CALC_MODES.PRICE_PER_ITEM, form: FORM_INCOME_AMS },
];
...
export const autoDiscounts = [
  ...
  // ============================================================================
  //
  // Чтобы добавить временную скидку, используйте параметр expiresAt в формате 'YYYY-MM-DD':
  // expiresAt: '2025-01-31' означает, что скидка действует до конца 31 января 2025 по Москве
  //
  // Пример 1: Временная скидка 50% на оформление
  // {
  ...
  // }
  //
  // Пример 2: Временная скидка на подарки до конца месяца
  // {
  //   id: 'gift-promo',
