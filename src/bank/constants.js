...
export const TEXT_MESSAGES = {
  ...
  BANNER_INFO: 'Разместите баннер нашего проекта в подписи своего пользователя на указанном форуме и получите выплату. Приложите ссылку на Ваш профиль или скрин.<br><br>Для каждого игрока начисление доступно <strong>только один раз</strong>.',
