 ...
 * Этот файл нужно вставить в iframe страницы банка как модуль
 *
 * Использование:
 * <script type="module" src="https://odeshock.github.io/QuadroBoards-Automatizations/src/bank/loader.js"></script>
 *
 * Функции:
 * - Устанавливает handshake с родительским окном
 * - Загружает app.js после получения ACK
