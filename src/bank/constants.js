...
export const TEXT_MESSAGES = {
  ...
  ADMIN_INFO: 'Начисление производится администратором при приёме анкеты.<br>Если Вас случайно пропустили, пожалуйста, напишите в Приёмную — мы обязательно всё проверим и разберёмся.',
  SCRIPT_INFO: 'За Вас всё посчитает скрипт — просто дайте ему немного времени.<br>Если у Вас появятся вопросы по подсчёту или что-то окажется не учтено, пожалуйста, напишите в Приёмную — мы обязательно поможем.',
  TOPUP_INFO: 'Начисления происходят <strong>1-го и 16-го числа<strong> каждого месяца.<br>Если вдруг что-то было упущено, напишите, пожалуйста, в Приёмную — мы обязательно всё проверим и решим вопрос.',
  AMS_INFO: 'Начисление по потребности производит администратор.',
  ...
  GRAPHIC_WORK_INFO: 'Учитываются только работы, опубликованные <strong>в графической теме</strong>.<br>Если несколько работ выложено в одном комментарии, укажите этот комментарий <strong>несколько раз</strong>.<br>Если выложено несколько версий одной работы с минимальными различиями, учитывается <strong>только одна из них</strong>.',
  CONTEST_INFO: 'Каждый конкурс учитывается <strong>только один раз</strong>.',
  THIRDCHAR_INFO: 'Допустимо иметь <strong>не более пяти персонажей</strong>.<br>До оплаты услуги <strong>получите согласие администрации</strong> в Приёмной и приложите сюда ссылку на комментарий.',
  REFUSE_INFO: 'При отказе от роли, Ваш профиль переименовывается в выбранную <strong>фантастическую тварь</strong>.<br>Если у Вас несколько профилей, останется <strong>только один — этот</strong>.',
  BANNER_INFO: 'Разместите баннер нашего проекта в подписи своего пользователя на указанном форуме и получите выплату. Приложите ссылку на Ваш профиль или скрин.<br>Для каждого игрока начисление доступно <strong>только один раз</strong>.',
  ...
  ERROR_REFRESH: 'Произошла ошибка. Пожалуйста, обновите страницу.',
