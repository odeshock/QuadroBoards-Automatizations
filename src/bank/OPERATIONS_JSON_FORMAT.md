...
- ✅ **Новые корректировки применяются**, если их нет в backup
- ✅ **Новые скидки применяются**, если их нет в backup
...
**Логика дублирования:**
- Система проверяет ID корректировок/скидок из backup
- Если новая корректировка/скидка имеет такой же ID — она пропускается
- Если ID нет в backup — новое правило применяется
