...
export const TEXT_MESSAGES = {
  ...
  ADMIN_INFO: 'Начисление производится администратором при приёме анкеты. Если Вас случайно пропустили, пожалуйста, напишите в Приёмную — мы обязательно всё проверим и разберёмся.',
  SCRIPT_INFO: 'За Вас всё посчитает скрипт — просто дайте ему немного времени. Если у Вас появятся вопросы по подсчёту или что-то окажется не учтено, пожалуйста, напишите в Приёмную — мы обязательно поможем.',
  TOPUP_INFO: 'Начисления происходят 1-го и 16-го числа каждого месяца. Если вдруг что-то было упущено, напишите, пожалуйста, в Приёмную — мы обязательно всё проверим и решим вопрос.',
  ...
  BANNER_INFO: 'Разместите баннер нашего проекта в подписи своего пользователя на указанном форуме и получите выплату. Приложите ссылку на Ваш профиль или скрин. Увы, для каждого форума начисление доступно игроку <strong>лишь раз</strong>.',
