...
1. 222 × 50% = 111
2. (120+222-111-40(купон за подарок)) x 75% = 191 x 75% = 144 (суммарно не превышает 120+222-40(за купон)=302, поэтому эта скидка учитывается полностью)
3. Результат: 111+144=255 автом.скидка

Итого: -120-222+40+255 = −47
