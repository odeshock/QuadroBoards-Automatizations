...
## ⚠️ Группа 11: Несколько корректировок (подарки коллекция + индивидуальные)

### ⚠️ Тест 11.1: Обе корректировки применяются
**Начальная корзина:**
- 5 подарков из коллекции × 40₽ = 200₽
- 5 индивидуальных подарков × 40₽ = 200₽

**Правила корректировок:**
- "За 5 подарков из коллекции": 40×1×5 - 180×1 = 20₽
- "За 5 индивидуальных подарков": 40×1×5 - 180×1 = 20₽
...
Индивидуальные подарки: -200₽
Купоны: 0₽
Корректировки: +40₽
  - За 5 подарков из коллекции: 20
  - За 5 индивидуальных подарков: 20
Автоскидки: +270₽ (75% от (400-0-40) = 75% от 360)
ИТОГО: -90₽
```

---

### ⚠️ Тест 11.2: Item купон влияет на одну корректировку
**Начальная корзина:**
- 5 подарков из коллекции × 40₽ = 200₽
- 5 индивидуальных подарков × 40₽ = 200₽
...
Корректировки: +20₽
  ...
  - За 5 индивидуальных подарков: 20 (не затронуты купоном)
Автоскидки: +255₽ (75% от (400-40-20) = 75% от 340, округление вверх)
ИТОГО: -85₽
```
...
### ⚠️ Тест 11.3: Fixed купон НЕ влияет на корректировки
**Начальная корзина:**
- 5 подарков из коллекции × 40₽ = 200₽
- 5 индивидуальных подарков × 40₽ = 200₽
...
Корректировки: +40₽
  ...
  - За 5 индивидуальных подарков: 20
Автоскидки: +158₽ (75% от (400-150-40) = 75% от 210, округление вверх)
ИТОГО: -52₽
```
...
### ⚠️ Тест 11.4: Percent купон видит обе корректировки
**Начальная корзина:**
- 5 подарков из коллекции × 40₽ = 200₽
- 5 индивидуальных подарков × 40₽ = 200₽
...
Корректировки: +40₽
  - За 5 подарков из коллекции: 20
  - За 5 индивидуальных подарков: 20
Автоскидки: +237₽ (75% от (400-45-40) = 75% от 315, округление вверх)
ИТОГО: -78₽
```
...
### ⚠️ Тест 11.5: Комплексный сценарий с двумя формами
**Начальная корзина:**
...
Корректировки: +40₽
  ...
  - За 5 индивидуальных подарков: 20
Автоскидки: +176₽ (75% от (480-206-40) = 75% от 234, округление вверх)
ИТОГО: -58₽
```
